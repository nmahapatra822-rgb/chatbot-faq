...
class FAQChatbot:
    def __init__(self):
        ...
        # 2. Robust CSV Loading System
        if os.path.exists(self.csv_path):
            try:
                self.df = pd.read_csv(self.csv_path)
                # Normalize column headers to lowercase to prevent typos
        ...
        # 3. Free API Key Setup (Gemini 2.5 Flash / Free Tier)
        # Instructors love seeing API keys handled securely via environment variables
    ...
    def _call_gemini_fallback(self, query):
        ...
        # System instructions to keep the bot professional
        prompt_payload = {
            "contents": [{
        ...
        try:
            ...
            with urllib.request.urlopen(req, timeout=5) as response:
                ...
                # Extract text out of the nested Gemini response structure securely
